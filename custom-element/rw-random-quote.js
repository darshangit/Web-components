class RwRandomQoute extends HTMLElement {
    constructor() {
        super();

        this._quotes = ["All we have to do is the time", "I am Awesome", "Even you are aweome"];
        this._$quote = null;
        this._interval = null;
    }
    ...
    _render() {
        if(this._$quote !== null) {
            ...
            this.setAttribute("current-index", index); // this will be displayed on the component html.
...
window.customElements.define("rw-random-quote", RwRandomQoute);